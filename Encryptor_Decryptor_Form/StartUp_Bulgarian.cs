...
namespace Encryptor_Decryptor_Form
{
    public partial class StartUp_Bulgarian : Form
    {
        ...
        {
            SetControlVisibility(false, Username_Error, Password_Error, Account_Already_Exists, Empty_Username, Empty_Password, Username_Spaces, Password_Spaces, Password_Length, Username_Length, Account_Not_Found, Recipient_Error, Recipient_Not_Found);
        }
